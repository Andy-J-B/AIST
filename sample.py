...
class Set:
    ...
    def setClassification(self, ORL: float) -> str:
        """
        Classify Sets as upward or downward
        Upward Set Definition:
            • slope>0
            • Final close value: absolute high
            • First open value: absolute low
        Downward Set Definition:
            • Slope<0x
            • Final close value: absolute low
            • First open value: absolute high
        """
        if ORL > 0:
            return "UPWARD"
        elif ORL < 0:
